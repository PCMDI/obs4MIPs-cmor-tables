...
inputJson = 'clim_demo_input.json' ; # Update contents of this file to set your global_attributes
inputFilePath = 'MPI-ULB-SOM_FFN_clim.nc'
inputVarName = 'pco2'
outputVarName = 'pco2'
outputUnits = 'muatm'
...
####
# climatological mean period: 1998–2015 (see https://essd.copernicus.org/articles/12/2537/2020)
...
cmorTime = cmor.axis("time", coord_vals=time[:], units= f.time.units)
