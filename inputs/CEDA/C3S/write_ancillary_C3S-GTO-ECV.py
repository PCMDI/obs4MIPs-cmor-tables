...
#output directory
outdir='~/obs4mips/obs4MIPs/DLR-BIRA/C3S-GTO-ECV-9-0/mon/toz/gn/v20230213/'

#read in toz obs4mips files
obs4mips_file = '~/obs4mips/obs4MIPs/DLR-BIRA/C3S-GTO-ECV-9-0/mon/toz/gn/v20230213/toz_mon_C3S-GTO-ECV-9-0_BE_gn_199507-202204.nc'

#read in with xcdat
data = xcdat.open_dataset(obs4mips_file)
...
#write out data
dataset_toc_n_obs.to_netcdf(outdir+'n_obs-toz_mon_C3S-GTO-ECV-9-0_BE_gn_199507-202204.nc','w',format='NETCDF4_CLASSIC',encoding=encoding)
...
dataset_toc_sd.to_netcdf(outdir+'sd-toz_mon_C3S-GTO-ECV-9-0_BE_gn_199507-202204.nc','w',format='NETCDF4_CLASSIC',encoding=encoding)
...
dataset_toc_serr.to_netcdf(outdir+'sderr-toz_mon_C3S-GTO-ECV-9-0_BE_gn_199507-202204.nc','w',format='NETCDF4_CLASSIC',encoding=encoding)
