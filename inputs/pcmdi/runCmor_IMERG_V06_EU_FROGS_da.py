...
inputJson = 'IMERG_V06_EU_FROGS_da-input.json' ; # Update contents of this file to set your global_attributes
inputFilePathbgn = '/p/user_pub/pmp/pmp_obs_preparation/orig/data/FROGS_precip/'
inputFilePathend = '/IMERG_V06_EU/'
inputFileName = ['IMERG_V06_EU.1DD.2001-2017.xml']
inputVarName = ['rain']
outputVarName = ['pr']
