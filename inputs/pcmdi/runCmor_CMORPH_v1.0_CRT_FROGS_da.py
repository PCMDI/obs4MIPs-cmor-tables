...
inputJson = 'CMORPH_v1.0_CRT_FROGS_da-input.json' ; # Update contents of this file to set your global_attributes
inputFilePathbgn = '/p/user_pub/pmp/pmp_obs_preparation/orig/data/FROGS_precip/'
inputFilePathend = '/CMORPH_v1.0_CRT/'
inputFileName = ['CMORPH_V1.0.1DD.1998-2012.xml']
inputVarName = ['rain']
outputVarName = ['pr']
