...
inputJson = 'OISST-L4-AVHRR-only-v2.json' ; # Update contents of this file to set your global_attributes
inputFilePathbgn = '/p/user_pub/pmp/pmp_obs_preparation/orig/data/'
inputFilePathend = '//OISST/xmls/'
inputFileName = ['OISST_tos_mo.xml']
inputVarName = ['tos']
outputVarName = ['ts']
outputUnits = ['K']
