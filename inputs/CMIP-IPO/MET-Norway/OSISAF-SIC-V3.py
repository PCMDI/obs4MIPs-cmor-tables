...
inputJson = 'OSISAF-SIC-V3.json' ; # Update contents of this file to set your global_attributes
inputFileDir = '../../../../indata' # Folder with montly input files
inputFileName = 'ice_conc_glb_latlon-050deg_cdr-v3p0_*.nc' # Filename pattern of monthly input files
