...
# Configuration
# ============================================================================
input_dir = '/Users/paul.smith/obs4MIPs-cmor-tables/inputs/MET-Norway/MET-Norway/OSI-450-sh' # Change to sh or nh depending on hemisphere
input_pattern = 'OBS_OSI-450-nh_reanaly_v3_OImon_sic_*.nc'
output_dir = '/Users/paul.smith/obs4MIPs-cmor-tables/inputs/MET-Norway/MET-Norway/OSI-450-sh-regridded' # change to sh or nh 
variable_name = 'sic'
...
target_lat_min = 0.25   # Start at 0.25 so first bound is at 0 
target_lat_max = 89.75  # End at 89.75 so last bound is at 90
