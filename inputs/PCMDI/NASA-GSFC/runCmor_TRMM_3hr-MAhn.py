...
inputJson = 'TRMM_3hr-MAhn-input.json' ; # Update contents of this file to set your global_attributes

inputFilePathbgn = '/work/ahn6/obs/TRMM/TRMM_3B42.7/'
inputFilePathend = '/3hr_2deg/'
