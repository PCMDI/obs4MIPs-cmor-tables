...
inputJson = 'TRMM_3B42_v7.0_FROGS_da-input.json' ; # Update contents of this file to set your global_attributes
inputFilePathbgn = '/p/user_pub/pmp/pmp_obs_preparation/orig/data/FROGS_precip/'
inputFilePathend = '/3B42_v7.0/'
inputFileName = ['3B42v7.1DD.1998-2019.xml']
inputVarName = ['rain']
outputVarName = ['pr']
