...
inputJson = 'IMERG_V06_LU_FROGS_da-input.json' ; # Update contents of this file to set your global_attributes
inputFilePathbgn = '/p/user_pub/pmp/pmp_obs_preparation/orig/data/FROGS_precip/'
inputFilePathend = '/IMERG_V06_LU/'
inputFileName = ['IMERG_V06_LU.1DD.2001-2020.xml']
inputVarName = ['rain']
outputVarName = ['pr']
