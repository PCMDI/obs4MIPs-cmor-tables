...
inputJson = 'RSS-mwir-oisst-v5.1.json' ; # Update contents of this file to set your global_attributes
inputDatasets = '../../../../../files-obs4MIPs/RSS/MWIR_OISST/*.nc' # change to local path on user's machine where files are stored
