...
inputJson = 'RSS_tls_v04r01.json' ; # Update contents of this file to set your global_attributes
inputFilePath = '/mnt/sagan/g/obs4MIPs/msu_data/RSS_Tb_Maps_ch_TLS_V4_0.nc'    # change to location on user's machine
