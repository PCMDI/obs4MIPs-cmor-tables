...
inputJson = 'GSMaP_v5_monthly.json' ; # Update contents of this file to set your global_attributes
inputFilePath = '/global/cfs/projectdirs/m4581/obs4MIPs/obs4MIPs_input/JAXA-20260422/GSMaP/monthly/version5'
...
for year in range(1998, 2027):  # put the years you want to process here
    inputFiles = glob.glob(f"{inputFilePath}/GPMMRG_MAP_{str(year)[-2:]}??_M_L3S_MCN_05?.nc")
    if len(inputFiles) == 0:
        continue
